"""Georgia adapter (live verification).

Georgia state-adoption coverage. The cycles in adoption_data.json are
...
Usage:
    python3 scripts/adapters/ga.py
    python3 scripts/adapters/ga.py --fixture FILE
    python3 scripts/adapters/ga.py --out scraped/GA.json
"""
...
STATE_CODE = "GA"
STATE_NAME = "Georgia"
SOURCE_URL = "https://gadoe.org/learning"
WARMUP_URL = 'https://gadoe.org/'

EXTRA_HOSTS = ()


def fetch_html(url=SOURCE_URL):
    """Fetch the Georgia DOE IM hub."""
