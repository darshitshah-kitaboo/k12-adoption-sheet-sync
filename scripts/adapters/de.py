"""Delaware adapter (local-control).

Delaware is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/de.py
    python3 scripts/adapters/de.py --fixture FILE
    python3 scripts/adapters/de.py --out scraped/DE.json
"""
...
STATE_CODE = "DE"
STATE_NAME = "Delaware"
SOURCE_URL = "https://www.doe.k12.de.us/domain/468"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Delaware curriculum hub through the shared helper."""
