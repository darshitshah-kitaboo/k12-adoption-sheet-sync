"""Washington adapter (local-control).

Washington is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/wa.py
    python3 scripts/adapters/wa.py --fixture FILE
    python3 scripts/adapters/wa.py --out scraped/WA.json
"""
...
SOURCE_URL = "https://ospi.k12.wa.us/student-success/learning-standards-instructional-materials"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Washington curriculum hub through the shared helper."""
