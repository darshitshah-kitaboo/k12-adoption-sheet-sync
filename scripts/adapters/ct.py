"""Connecticut adapter (local-control).

Connecticut is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ct.py
    python3 scripts/adapters/ct.py --fixture FILE
    python3 scripts/adapters/ct.py --out scraped/CT.json
"""
...
SOURCE_URL = "https://portal.ct.gov/sde/academic-office/academic-office"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Connecticut curriculum hub through the shared helper."""
