"""Ohio adapter (local-control).

Ohio is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/oh.py
    python3 scripts/adapters/oh.py --fixture FILE
    python3 scripts/adapters/oh.py --out scraped/OH.json
"""
...
STATE_CODE = "OH"
STATE_NAME = "Ohio"
SOURCE_URL = "https://education.ohio.gov/Topics/Learning-in-Ohio"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Ohio curriculum hub through the shared helper."""
