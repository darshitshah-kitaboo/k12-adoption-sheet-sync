"""Colorado adapter (local-control).

Colorado is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/co.py
    python3 scripts/adapters/co.py --fixture FILE
    python3 scripts/adapters/co.py --out scraped/CO.json
"""
...
STATE_CODE = "CO"
STATE_NAME = "Colorado"
SOURCE_URL = "https://www.cde.state.co.us/standardsandinstruction"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Colorado curriculum hub through the shared helper."""
