"""South Dakota adapter (local-control).

South Dakota is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/sd.py
    python3 scripts/adapters/sd.py --fixture FILE
    python3 scripts/adapters/sd.py --out scraped/SD.json
"""
...
SOURCE_URL = "https://doe.sd.gov/contentstandards/"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the South Dakota curriculum hub through the shared helper."""
