"""Nevada adapter (live verification).

Nevada runs state-adoption with a small number of subject cycles
...
Usage:
    python3 scripts/adapters/nv.py
    python3 scripts/adapters/nv.py --fixture FILE
    python3 scripts/adapters/nv.py --out scraped/NV.json
"""
...
STATE_CODE = "NV"
STATE_NAME = "Nevada"
SOURCE_URL = "https://doe.nv.gov/offices/office-of-teaching-and-learning/instructional-materials/"
WARMUP_URL = None
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Nevada DOE IM hub through the shared helper."""
