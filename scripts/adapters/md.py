"""Maryland adapter (local-control).

Maryland is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/md.py
    python3 scripts/adapters/md.py --fixture FILE
    python3 scripts/adapters/md.py --out scraped/MD.json
"""
...
STATE_CODE = "MD"
STATE_NAME = "Maryland"
SOURCE_URL = "https://marylandpublicschools.org/about/Pages/DCAA/index.aspx"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Maryland curriculum hub through the shared helper."""
