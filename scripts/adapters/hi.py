"""Hawaii adapter (live verification).

Hawaii state-adoption coverage. The cycles in adoption_data.json are
...
Usage:
    python3 scripts/adapters/hi.py
    python3 scripts/adapters/hi.py --fixture FILE
    python3 scripts/adapters/hi.py --out scraped/HI.json
"""
...
STATE_CODE = "HI"
STATE_NAME = "Hawaii"
SOURCE_URL = "https://www.hawaiipublicschools.org/TeachingAndLearning/StudentLearning/Pages/home.aspx"
WARMUP_URL = 'https://www.hawaiipublicschools.org/'

EXTRA_HOSTS = ()


def fetch_html(url=SOURCE_URL):
    """Fetch the Hawaii DOE IM hub."""
