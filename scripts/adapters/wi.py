"""Wisconsin adapter (local-control).

Wisconsin is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/wi.py
    python3 scripts/adapters/wi.py --fixture FILE
    python3 scripts/adapters/wi.py --out scraped/WI.json
"""
...
SOURCE_URL = "https://dpi.wi.gov/standards"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Wisconsin curriculum hub through the shared helper."""
