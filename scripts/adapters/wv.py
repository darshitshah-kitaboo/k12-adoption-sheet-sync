"""West Virginia adapter (live verification).

West Virginia runs state-adoption with a small number of subject cycles
...
Usage:
    python3 scripts/adapters/wv.py
    python3 scripts/adapters/wv.py --fixture FILE
    python3 scripts/adapters/wv.py --out scraped/WV.json
"""
...
SOURCE_URL = "https://wvde.us/middle-secondary-learning/resources/instructional-resources-review-and-adoption/adoption-schedule-law-code-and-policies/"
WARMUP_URL = "https://wvde.us/"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the West Virginia DOE IM hub through the shared helper."""
