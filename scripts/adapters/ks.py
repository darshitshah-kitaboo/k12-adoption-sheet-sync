"""Kansas adapter (local-control).

Kansas is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ks.py
    python3 scripts/adapters/ks.py --fixture FILE
    python3 scripts/adapters/ks.py --out scraped/KS.json
"""
