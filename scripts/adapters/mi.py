"""Michigan adapter (local-control).

Michigan is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/mi.py
    python3 scripts/adapters/mi.py --fixture FILE
    python3 scripts/adapters/mi.py --out scraped/MI.json
"""
...
STATE_CODE = "MI"
STATE_NAME = "Michigan"
SOURCE_URL = "https://www.michigan.gov/mde/services/academic-standards"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Michigan curriculum hub through the shared helper."""
