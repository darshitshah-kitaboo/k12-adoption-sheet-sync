"""California adapter (local-control).

California is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ca.py
    python3 scripts/adapters/ca.py --fixture FILE
    python3 scripts/adapters/ca.py --out scraped/CA.json
"""
...
def fetch_html(url=SOURCE_URL):
    """Fetch the California curriculum hub through the shared helper."""
