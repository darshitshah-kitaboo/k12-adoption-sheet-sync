"""Nebraska adapter (local-control).

Nebraska is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ne.py
    python3 scripts/adapters/ne.py --fixture FILE
    python3 scripts/adapters/ne.py --out scraped/NE.json
"""
...
STATE_CODE = "NE"
STATE_NAME = "Nebraska"
SOURCE_URL = "https://www.education.ne.gov/contentareastandards/"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Nebraska curriculum hub through the shared helper."""
