"""Maine adapter (local-control).

Maine is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/me.py
    python3 scripts/adapters/me.py --fixture FILE
    python3 scripts/adapters/me.py --out scraped/ME.json
"""
