"""Arkansas adapter (live verification).

Arkansas state-adoption coverage. The cycles in adoption_data.json are
...
Usage:
    python3 scripts/adapters/ar.py
    python3 scripts/adapters/ar.py --fixture FILE
    python3 scripts/adapters/ar.py --out scraped/AR.json
"""
...
STATE_CODE = "AR"
STATE_NAME = "Arkansas"
SOURCE_URL = "https://aredreports.ade.arkansas.gov/"
WARMUP_URL = None
