"""Alaska adapter (local-control).

Alaska is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ak.py
    python3 scripts/adapters/ak.py --fixture FILE
    python3 scripts/adapters/ak.py --out scraped/AK.json
"""
...
STATE_CODE = "AK"
STATE_NAME = "Alaska"
SOURCE_URL = "https://education.alaska.gov/standards"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Alaska curriculum hub through the shared helper."""
