"""North Dakota adapter (local-control).

North Dakota is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/nd.py
    python3 scripts/adapters/nd.py --fixture FILE
    python3 scripts/adapters/nd.py --out scraped/ND.json
"""
...
SOURCE_URL = "https://www.nd.gov/dpi/educators/academic-content-standards"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the North Dakota curriculum hub through the shared helper."""
