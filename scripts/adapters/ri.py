"""Rhode Island adapter (local-control).

Rhode Island is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ri.py
    python3 scripts/adapters/ri.py --fixture FILE
    python3 scripts/adapters/ri.py --out scraped/RI.json
"""
...
SOURCE_URL = "https://www.ride.ri.gov/InstructionAssessment/CurriculumInstruction.aspx"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Rhode Island curriculum hub through the shared helper."""
