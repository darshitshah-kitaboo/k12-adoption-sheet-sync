"""Massachusetts adapter (local-control).

Massachusetts is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ma.py
    python3 scripts/adapters/ma.py --fixture FILE
    python3 scripts/adapters/ma.py --out scraped/MA.json
"""
...
SOURCE_URL = "https://www.doe.mass.edu/instruction/"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Massachusetts curriculum hub through the shared helper."""
