"""District of Columbia adapter (local-control).

District of Columbia is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/dc.py
    python3 scripts/adapters/dc.py --fixture FILE
    python3 scripts/adapters/dc.py --out scraped/DC.json
"""
