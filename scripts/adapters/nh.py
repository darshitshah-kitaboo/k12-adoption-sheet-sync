"""New Hampshire adapter (local-control).

New Hampshire is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/nh.py
    python3 scripts/adapters/nh.py --fixture FILE
    python3 scripts/adapters/nh.py --out scraped/NH.json
"""
...
SOURCE_URL = "https://www.education.nh.gov/who-we-are/division-of-learner-support/bureau-of-instructional-support"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the New Hampshire curriculum hub through the shared helper."""
