"""Arizona adapter (local-control).

Arizona is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/az.py
    python3 scripts/adapters/az.py --fixture FILE
    python3 scripts/adapters/az.py --out scraped/AZ.json
"""
...
STATE_CODE = "AZ"
STATE_NAME = "Arizona"
SOURCE_URL = "https://www.azed.gov/standards-practices"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Arizona curriculum hub through the shared helper."""
