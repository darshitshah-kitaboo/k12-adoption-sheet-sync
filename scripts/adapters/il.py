"""Illinois adapter (local-control).

Illinois is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/il.py
    python3 scripts/adapters/il.py --fixture FILE
    python3 scripts/adapters/il.py --out scraped/IL.json
"""
...
STATE_CODE = "IL"
STATE_NAME = "Illinois"
SOURCE_URL = "https://www.isbe.net/Pages/Learning-Standards.aspx"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Illinois curriculum hub through the shared helper."""
