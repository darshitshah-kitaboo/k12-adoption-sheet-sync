"""Wyoming adapter (local-control).

Wyoming is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/wy.py
    python3 scripts/adapters/wy.py --fixture FILE
    python3 scripts/adapters/wy.py --out scraped/WY.json
"""
...
STATE_CODE = "WY"
STATE_NAME = "Wyoming"
SOURCE_URL = "https://edu.wyoming.gov/for-district-leadership/standards/"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Wyoming curriculum hub through the shared helper."""
