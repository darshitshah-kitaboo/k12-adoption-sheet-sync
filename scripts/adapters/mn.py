"""Minnesota adapter (local-control).

Minnesota is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/mn.py
    python3 scripts/adapters/mn.py --fixture FILE
    python3 scripts/adapters/mn.py --out scraped/MN.json
"""
...
SOURCE_URL = "https://education.mn.gov/MDE/dse/stds/"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Minnesota curriculum hub through the shared helper."""
