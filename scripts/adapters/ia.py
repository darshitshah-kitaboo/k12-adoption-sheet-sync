"""Iowa adapter (local-control).

Iowa is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ia.py
    python3 scripts/adapters/ia.py --fixture FILE
    python3 scripts/adapters/ia.py --out scraped/IA.json
"""
...
STATE_CODE = "IA"
STATE_NAME = "Iowa"
SOURCE_URL = "https://educate.iowa.gov/pk-12/standards"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Iowa curriculum hub through the shared helper."""
