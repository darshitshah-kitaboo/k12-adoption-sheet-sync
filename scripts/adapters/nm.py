"""New Mexico adapter (live verification).

New Mexico runs state-adoption with a small number of subject cycles
...
Usage:
    python3 scripts/adapters/nm.py
    python3 scripts/adapters/nm.py --fixture FILE
    python3 scripts/adapters/nm.py --out scraped/NM.json
"""
...
SOURCE_URL = "https://web.ped.nm.gov/bureaus/instructional-materials/"
WARMUP_URL = 'https://web.ped.nm.gov/'
...
def fetch_html(url=SOURCE_URL):
    """Fetch the New Mexico DOE IM hub through the shared helper."""
