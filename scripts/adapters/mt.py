"""Montana adapter (local-control).

Montana is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/mt.py
    python3 scripts/adapters/mt.py --fixture FILE
    python3 scripts/adapters/mt.py --out scraped/MT.json
"""
...
STATE_CODE = "MT"
STATE_NAME = "Montana"
SOURCE_URL = "https://opi.mt.gov/Educators/Teaching-Learning"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Montana curriculum hub through the shared helper."""
