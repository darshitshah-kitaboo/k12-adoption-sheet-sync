"""Kentucky adapter (local-control).

Kentucky is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ky.py
    python3 scripts/adapters/ky.py --fixture FILE
    python3 scripts/adapters/ky.py --out scraped/KY.json
"""
...
STATE_CODE = "KY"
STATE_NAME = "Kentucky"
SOURCE_URL = "https://www.education.ky.gov/curriculum/books/Pages/default.aspx"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Kentucky curriculum hub through the shared helper."""
