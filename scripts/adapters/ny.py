"""New York adapter (local-control).

New York is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/ny.py
    python3 scripts/adapters/ny.py --fixture FILE
    python3 scripts/adapters/ny.py --out scraped/NY.json
"""
...
def fetch_html(url=SOURCE_URL):
    """Fetch the New York curriculum hub through the shared helper."""
