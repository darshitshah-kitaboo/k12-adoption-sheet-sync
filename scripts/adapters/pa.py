"""Pennsylvania adapter (local-control).

Pennsylvania is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/pa.py
    python3 scripts/adapters/pa.py --fixture FILE
    python3 scripts/adapters/pa.py --out scraped/PA.json
"""
...
SOURCE_URL = "https://www.education.pa.gov/K-12/Curriculum%20and%20Instruction/Pages/default.aspx"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Pennsylvania curriculum hub through the shared helper."""
