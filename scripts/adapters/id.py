"""Idaho adapter (live verification).

Idaho runs state-adoption with a small number of subject cycles
...
Usage:
    python3 scripts/adapters/id.py
    python3 scripts/adapters/id.py --fixture FILE
    python3 scripts/adapters/id.py --out scraped/ID.json
"""
...
STATE_CODE = "ID"
STATE_NAME = "Idaho"
SOURCE_URL = "https://www.sde.idaho.gov/about-us/departments/content-and-curriculum/curricular-materials/"
WARMUP_URL = None
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Idaho DOE IM hub through the shared helper."""
