"""Missouri adapter (local-control).

Missouri is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/mo.py
    python3 scripts/adapters/mo.py --fixture FILE
    python3 scripts/adapters/mo.py --out scraped/MO.json
"""
...
STATE_CODE = "MO"
STATE_NAME = "Missouri"
SOURCE_URL = "https://dese.mo.gov/college-career-readiness/curriculum"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Missouri curriculum hub through the shared helper."""
