"""Vermont adapter (local-control).

Vermont is a local-control state. Districts pick instructional
...
Usage:
    python3 scripts/adapters/vt.py
    python3 scripts/adapters/vt.py --fixture FILE
    python3 scripts/adapters/vt.py --out scraped/VT.json
"""
...
STATE_CODE = "VT"
STATE_NAME = "Vermont"
SOURCE_URL = "https://education.vermont.gov/student-learning/content-areas"
...
def fetch_html(url=SOURCE_URL):
    """Fetch the Vermont curriculum hub through the shared helper."""
